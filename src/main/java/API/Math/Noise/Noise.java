...
public abstract class Noise {
     ...
     */
    public static final double[] RANDOM_VECTORS3D = {
    ...
    /*
     2D Perlin Noise
    */
    public static final int MAX_OCTAVE = 8, MIN_OCTAVE = 1, N_COUNT = 256;
    public static final double[] RANDOM_VECTORS2D = new double[N_COUNT * N_COUNT]; //seed array
    public static final double[] PERLIN_VECTORS2D = new double[RANDOM_VECTORS2D.length];
    protected static final double[] RANDOM_VECTORS_PERLIN3D = new double[RANDOM_VECTORS3D.length];
    ...
    public static int OCTAVE_COUNT = 1;
    public static float SCALING_BIAS = 2.0f;
    ...
    public static void setupLegacyMode(boolean enableLegacyRange) {
        ...
        for (int i = 0; i < RANDOM_VECTORS3D.length; i++) {
            RANDOM_VECTORS_PERLIN3D[i] = RANDOM_VECTORS3D[i] / (legacyMultiplier * NORMALIZER_PERLIN);
        }
    }
